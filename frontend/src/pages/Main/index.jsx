  ...
  return (
    <div className={'main'}>
      ...
      <section className={'main__description'}>
        ...
        <p>
          Каждый день перед Новым Годом ты сможешь изучать / повторять по одной небольшой и несложной теме и эта
          структурированность даст отличный буст к твоему развитию
        </p>
